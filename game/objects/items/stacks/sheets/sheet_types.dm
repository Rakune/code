...
var/global/list/datum/stack_recipe/metal_recipes = list ( \
    new/datum/stack_recipe("Hydroponic farm", /obj/machinery/portable_atmospherics/hydroponics, 15, time = 10, one_per_turf = 1, on_floor = 1),
	...
	null, \
	new/datum/stack_recipe("Hydroponics farm", /obj/machinery/portable_atmospherics/hydroponics, 10), \
...
/*		new/datum/stack_recipe("science airlock assembly", /obj/structure/door_assembly/door_assembly_science, 4, time = 50, one_per_turf = 1, on_floor = 1), \ */
	...
	new/datum/stack_recipe("juicer", /obj/machinery/juicer, 5, time = 20, one_per_turf = 1), \
	null, \
...
/*
*/
var/global/list/datum/stack_recipe/stones_recipes = list ( \
	new/datum/stack_recipe("stonewall", /obj/structure/stonewall, 10), \
	    new/datum/stack_recipe("Furnace", /obj/machinery/furnace, 20, time = 10, one_per_turf = 1, on_floor = 1),
)

/obj/item/stack/sheet/stones	//BubbleWrap
	name = "Stones"
	desc = "Large stones."
	singular_name = "Stone"
	icon_state = "stone"
...
/obj/item/stack/sheet/stones/New(var/loc, var/amount=null)
		recipes = stones_recipes
